 ...
 */
public class PlayVideo implements ControlObject{
    private final String contentType;
    private final String shortName;
    private final int seconds;

    public PlayVideo(String contentType, String shortName, int seconds) {
    ...
    public static PlayVideo create(ByteBuf msg) {
        ...
        return new PlayVideo(contentType, shortName, seconds);
    }
}
