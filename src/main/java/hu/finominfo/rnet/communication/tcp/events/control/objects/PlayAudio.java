 ...
 */
public class PlayAudio implements ControlObject{
    private final String contentType;
    private final String shortName;
    private final int seconds;

    public PlayAudio(String contentType, String shortName, int seconds) {
    ...
    public static PlayAudio create(ByteBuf msg) {
        ...
        return new PlayAudio(contentType, shortName, seconds);
    }
}
